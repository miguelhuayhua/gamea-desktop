      ...
      <Document>
        <Page style={styles.page} orientation="landscape" size={"LETTER"}>
          ...
          <Text style={{ ...styles.bigTitle, marginVertical: 10 }}>
            LISTADO DE ADULTOS DENUNCIANTES
          </Text>
            ...
            {adultos.map((value, index) => {
              return (
                <View key={index} style={styles.row}>
                  ...
                  <View style={styles.cell}>
                    <Text>{`${value.nombre} ${value.paterno} ${value.materno}`}</Text>
                  </View>
                  <View style={styles.cell}>
                    <Text>{value.f_nacimiento}</Text>
                  </View>
                  <View style={styles.cell}>
                    <Text>{value.nro_referencia}</Text>
                  </View>
                  <View style={styles.cell}>
                    <Text>{value.beneficios}</Text>
                  </View>
                  <View style={styles.cell}>
                    <Text>{value.edad}</Text>
                  </View>
                  <View style={styles.cell}>
                    <Text>{value.genero}</Text>
                  </View>
                  <View style={styles.cell}>
                    <Text>{value.estado_civil}</Text>
                  </View>
                  <View style={styles.cell}>
                    <Text>{value.grado}</Text>
                  </View>
                  <View style={styles.cell}>
                    <Text>{value.ocupacion}</Text>
                  </View>
                </View>
              );
            })}
