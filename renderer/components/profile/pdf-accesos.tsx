            ...
            <Document>
                <Page style={styles.page} orientation="landscape" size={"LETTER"}>
                    ...
                    <View style={styles.table}>
                        ...
                        {accesos.map((value, index) => {
                            return (
                                <View key={index} style={styles.row}>
                                    <View style={styles.cell}>
                                        <Text>{value.id_acceso}</Text>
                                    </View>
                                    <View style={styles.cell}>
                                        <Text>{dayjs(value.fecha_hora_acceso).format("DD/MM/YYYY")}</Text>
                                    </View>
                                    <View style={styles.cell}>
                                        <Text>
                                    ...
                                    <View style={styles.cell}>
                                        <Text>{dayjs(value.fecha_hora_salida).format("DD/MM/YYYY")}</Text>
                                    </View>
                                    <View style={styles.cell}>
                                        <Text>
